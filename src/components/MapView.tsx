...
// Opens the device's own Google Maps (native app if installed, else the web
// version) with walking directions already pointed at the egg. Leaving the
// origin blank makes Google Maps use the device's current location, so we
// don't need to track or forward the patrol's GPS ourselves at all.
...
export default function MapView({
        ...
        <div style="max-width:200px">
          ...
          ${
            enableDirections && !egg.collected
              ? `<a href="${googleMapsDirectionsUrl(egg.lat, egg.lng)}" target="_blank" rel="noopener noreferrer" style="display:block;margin-top:8px;width:100%;background:#2563eb;color:white;border:none;border-radius:8px;padding:7px 0;font-size:13px;font-weight:700;text-align:center;text-decoration:none">🧭 Directions</a>`
              : ""
          }
        </div>`;
  ...
  }, [teams, eggs, settings.mapMode, enableDirections]);
